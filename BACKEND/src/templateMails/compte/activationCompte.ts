// src/templateMails/activationCompte.ts

export const templateActivationCompte = (prenom: string, token: string) => `
  <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 20px; border-radius: 8px;">
      <h2 style="text-align: center; color: #333333;">Bienvenue chez <span style="color: #ff6600;">UrbanHeritage</span> !</h2>
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="${process.env.FRONTEND_URL}/activation?token=${token}" 
